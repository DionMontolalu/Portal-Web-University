    ...
    <div id="wrapper">
		...
		<!--  end modal bootstrap -->
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Pendaftaran PPDS</h1>
                </div>
                <!--End Page Header -->
            </div>
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                        $query = mysql_query("SELECT * FROM ppds");
                                        
                                        while ($data = mysql_fetch_array($query)) {
                                         $judul = preg_replace("/\s/","-",$data['judul']);
										 $url_link = "PPDS-".$data['id_pds']."-".$judul.".html";
										 
										 echo '<tr class="odd gradeX">';
                                         echo "<td>".$data['id_pds']."</td>";
