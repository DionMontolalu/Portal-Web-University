            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a>-> Kategori-> Tambah Kategori
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($nama==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Deskripsi tidak boleh kosong!", "warning")</script>';
                                    ...
                                    //insert ke tabel
                                    $query = "INSERT INTO kategori VALUES('','$nama','$deskripsi')";
                    ...
                    <label for="basic-url">Nama Kategori</label>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="basic-addon1">
                                ...
                                <input type="text" class="form-control" name="nama" placeholder="Nama Kategori" aria-describedby="basic-addon1">
                        </div><br>

                     <label for="basic-url">Deskripsi Singkat</label>
                        <textarea class="form-control" name="deskripsi" placeholder="Deskripsi singkat" rows="3"></textarea>
