                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($judul==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Isi tidak boleh kosong!", "warning")</script>';
                                    ...
                                    //insert ke tabel
                                    $query = "INSERT INTO pengumuman VALUES('','$judul','$isi',now(),now())";
                    ...
                    <label for="basic-url">Judul</label>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="basic-addon1">
                                ...
                                <input type="text" class="form-control" name="judul"  placeholder="Judul Pengumuman" aria-describedby="basic-addon1">
                        </div><br>
