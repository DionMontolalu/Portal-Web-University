...
<?php
    ...
    if (isset($_GET['id_ika'])) {
        $id_ika = htmlspecialchars($_GET['id_ika']);
    } else {
...
<head>
	...
	<meta name="keywords" content="ilmu kesehatan anak unsrat ,fakultas kedokteran unsrat, kedokteran unsrat, Ilmu Kesehatan Anak, Ika Unsrat, kedokteran ilmu kesehatan anak, Universitas Samratulangi, Kedokteran Universitas Samratulangi">
...
<body>
    ...
    <div class="container">
		<?php 
			include "rgx.php";
				$query = "SELECT * FROM ika WHERE id_ika = '$id_ika' ";
                ...
                <div class="panel panel-success" style="background: #3D5AFE; color: white">
					<div class="panel-body">
						...
						<?php
								...
								echo "				<img class='media-object' src='ika_admin/kedok_ika/gambar/$picture' width='75px' height='65px'>";
								echo '			</a>';
								echo '		</div>';
        ...
        <div class="row" style="background: white; color: green; border: 2px solid #3D5AFE;">
            ...
            <div class="column">
				<img src="img/keg/11.jpg" style="width:100%; height:200px;" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
            </div>
            <div class="column">
				<img src="img/keg/22.jpg" style="width:100%; height:200px;" onclick="openModal();currentSlide(2)" class="hover-shadow cursor">
            </div>
            <div class="column">
				<img src="img/keg/33.jpg" style="width:100%; height:200px;" onclick="openModal();currentSlide(3)" class="hover-shadow cursor">
            </div>
			 <div class="column">
				<img src="img/keg/44.jpg" style="width:100%; height:200px;" onclick="openModal();currentSlide(4)" class="hover-shadow cursor">
            </div>
			<br>
			<!-- The Modal -->
  ...
  <div class="modal-content">
    ...
    <div class="mySlides">
      ...
      <img src="img/keg/11.jpg" style="width:804px; height:350px;">
    </div>

    <div class="mySlides">
      <div class="numbertext">2 / 4</div>
      <img src="img/keg/22.jpg" style="width:804px; height:350px;">
    </div>

    <div class="mySlides">
      <div class="numbertext">3 / 4</div>
      <img src="img/keg/33.jpg" style="width:804px; height:350px;">
    </div>
    
    <div class="mySlides">
      <div class="numbertext">4 / 4</div>
      <img src="img/keg/44.jpg" style="width:804px; height:350px;">
    </div>
    ...
    <div class="column">
      <img class="demo cursor" src="img/keg/11.jpg" style="width:180px; height:110px;" onclick="currentSlide(1)" alt="Natal Bersama">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/keg/22.jpg" style="width:180px; height:110px;" onclick="currentSlide(2)" alt="Dies Natalis FK Unsrat">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/keg/33.jpg" style="width:180px; height:110px;" onclick="currentSlide(3)" alt="Dies Natalis di Kecamatan Kakas">
    </div>
    <div class="column">
      <img class="demo cursor" src="img/keg/44.jpg" style="width:180px; height:110px;" onclick="currentSlide(4)" alt="Natal Bersama">
    </div>
  </div>
</div>
		<!-- End Modal -->
