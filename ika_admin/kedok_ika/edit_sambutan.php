		...
		<!--  end modal bootstrap -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a>-> Halaman Utama-> Sambutan
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            <div class="row">
				...
				<?php
					include('rgx.php');
					$id = $_GET['id'];
					$show = mysql_query("SELECT * FROM sambutan WHERE id='$id'");
			...
			<?php
                        ...
                        if (isset($_POST['input'])) {
                            $id = $_POST['id'];
							$oleh = addslashes (strip_tags ($_POST['oleh']));
                            ...
                            if ($isi=="") {
                                echo '<script>swal("Kesalahan!", "Form Isi tidak boleh kosong!", "warning")</script>';
									...
									$sql = mysql_query("UPDATE sambutan SET oleh='$oleh' ,isi='$isi' WHERE id='$id'") or die(mysql_error());
									
                                    if ($sql){
                                        echo '<script>
												swal({
													title: "Berhasil",
													text: "Sambutan berhasil diupdate!",
													type: "success",
													},
												function(){
													window.location.href = "Sambutan";
												});
										</script>';
                                    }elseif (!$sql){
				...
				<input type="hidden" name="id" value="<?php echo $id; ?>">
                    <label for="basic-url">Oleh Siapa</label>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="basic-addon1">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                            </span>
                                <input type="text" class="form-control" name="oleh" value="<?php echo $data['oleh']; ?>" placeholder="Oleh Siapa" aria-describedby="basic-addon1">
                        </div><br>
                     <label for="basic-url">Isi</label>
                        <textarea name="isi" rows="20"><?php echo $data['isi']; ?></textarea>
					<br>		
					<br>
					<button type="submit" name="input" class="btn btn-warning ">
