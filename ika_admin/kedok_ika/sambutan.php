                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                    <?php
                                        $query = mysql_query("SELECT * FROM sambutan");
                                        while ($data = mysql_fetch_array($query)) { 
                                         echo '<tr class="odd gradeX">';
                                         echo "<td>".$data['id']."</td>";
                                         echo "<td>".$data['oleh']."</td>";
										 echo "<td>".$data['isi']."</td>";
                                         echo "<td><a href =edit_sambutan.php?id=$data[id]><center><h1 class='label label-warning'><strong>EDIT</strong></h1></center> </a>";
										echo "</tr>";
                                        }
                                    ?>
                                    </tbody>
