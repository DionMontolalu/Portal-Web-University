    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Halaman Utama<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="Sambutan">
                                    <i class="fa fa-plus-square" aria-hidden="true"></i>
		...
		<!--  end modal bootstrap -->
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit IKA</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a>-> Halaman-> IKA
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            <div class="row">
                ...
                <?php
					include('rgx.php');
					$id_ika = $_GET['id_ika'];
					$show = mysql_query("SELECT * FROM ika WHERE id_ika='$id_ika'");
                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($judul==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Isi tidak boleh kosong!", "warning")</script>';
									...
									$update = mysql_query("UPDATE ika SET judul='$judul', isi='$isi' 
									WHERE id_ika='$id_ika'") or die(mysql_error());
									...
									if ($update){
                                        echo '<script>
												...
												function(){
													window.location.href = "Halaman-IKA";
												});
										</script>';
                                    }elseif (!$update){
				...
				<input type="hidden" name="id_ika" value="<?php echo $id_ika; ?>">
