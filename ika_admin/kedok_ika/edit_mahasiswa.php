    ...
    <div id="wrapper">
		...
		<!--  end modal bootstrap -->
            ...
            <div class="row">
                <!-- Page Header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Page Mahasiswa</h1>
                </div>
                <!--End Page Header -->
            </div>
            ...
            <div class="row">
                ...
                <?php
					include('rgx.php');
					$id_mhs = $_GET['id_mhs'];
					$show = mysql_query("SELECT * FROM mahasiswa WHERE id_mhs='$id_mhs'");
                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($judul==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Isi tidak boleh kosong!", "warning")</script>';
									...
									$update = mysql_query("UPDATE mahasiswa SET judul='$judul', isi='$isi' 
									WHERE id_mhs='$id_mhs'") or die(mysql_error());
									...
									if ($update){
                                        echo '<script>
												swal({
													title:"Berhasil",
													text: "Visi dan Misi berhasil diupdate!",
													type: "success",
													},
												function(){
													window.location.href = "Halaman-Mahasiswa";
												});
											</script>';
                                    }elseif (!$update){
