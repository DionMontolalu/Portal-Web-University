		...
		<!--  end modal bootstrap -->
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="alert alert-info">
                        <a href="home.php"><i class="fa fa-dashboard"></i> Dashboard</a>-> Halaman-> Profil
                    </div>
                </div>
                <!--end  Welcome -->
            </div>
            <div class="row">
                ...
                <?php
					include('rgx.php');
					$id_vm = $_GET['id_vm'];
					$show = mysql_query("SELECT * FROM profil WHERE id_vm='$id_vm'");
                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($judul==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Isi tidak boleh kosong!", "warning")</script>';
									...
									$update = mysql_query("UPDATE profil SET judul='$judul', isi='$isi' 
									WHERE id_vm='$id_vm'") or die(mysql_error());
									...
									if ($update){
                                        echo '<script>
												swal({
													title: "Berhasil",
													text: "Visi dan Misi berhasil di Update!",
													type: "success",
													},
												function(){
				...
				<input type="hidden" name="id_vm" value="<?php echo $id_vm; ?>">
