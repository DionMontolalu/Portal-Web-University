		...
		<!--  end modal bootstrap -->
            ...
            <div class="row">
				...
				<?php
					...
					$show = mysql_query("SELECT * FROM pengumuman WHERE id_peng='$id_peng'");
                        ...
                        if (isset($_POST['input'])) {
                            ...
                            if($judul==""){
                                ...
                                echo '<script>swal("Kesalahan!", "Form Isi tidak boleh kosong!", "warning")</script>';
									...
									$sql = mysql_query("UPDATE pengumuman SET judul='$judul', isi='$isi' 
									WHERE id_peng='$id_peng'") or die(mysql_error());
                    ...
                    <label for="basic-url">Judul</label>
                        <div class="input-group input-group-lg">
                            <span class="input-group-addon" id="basic-addon1">
                                ...
                                <input type="text" class="form-control" name="judul" value="<?php echo $data['judul']; ?>" placeholder="Judul Pengumuman" aria-describedby="basic-addon1">
                        </div><br>

                     <label for="basic-url">Isi</label>
                            <textarea name="isi" rows="20"><?php echo $data['isi']; ?></textarea>
							<br><button type="submit" name="input" class="btn btn-info ">
